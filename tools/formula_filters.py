...
# Function to filter for "proper oxides" with capability to exclude common complex anions
# and other specific formulas (e.g. known hydroxides).
...
def proper_oxides(df, metal_oxides_only=False, filter_complex=True,
    ...
    ''' Args:
            df (pandas.DataFrame): Dataframe to filter. Must have 'formula' column.
